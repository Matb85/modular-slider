...
import {Carousel, slideHandler, pagination, buttons, autoplay } from "@/index";
...
export const code = `import { Carousel, slideHandler, pagination, buttons, autoplay } from "modular-slider";
